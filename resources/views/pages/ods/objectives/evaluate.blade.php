...
@section('content')
    <div class="row mb-2">
        ...
        <div class="col-2 text-right">
            <a href="{{ route('ods.strategy.index', $objective->token) }}" class="btn btn-danger mt-5">{{ __('pagination.return') }}</a>
        </div>
    ...
    <evaluation objective="{{ json_encode($objective) }}" strategy="{{ json_encode($strategy) }}"></evaluation>
@endsection
